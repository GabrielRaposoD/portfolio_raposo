...
const ServiceItem: React.FC<ServiceItemProps> = ({
  ...
  return (
    <div className='cursor-grab bg-lightGray gap-y-3 group hover:border-purple-700 flex flex-col items-center p-10 transition-all duration-500 ease-in-out border-b-2 border-transparent border-solid'>
